...
cat1_path = phot_dir / "ngc5068_jwst_convolved_pah_f360m_phot_cat_fwhm2rad1.0.csv"
cat2_path = phot_dir / "ngc5068_jwst_convolved_pah_f360m_phot_cat_fwhm2rad2.0.csv"
...
ax.plot(f1, f2, "k.", ms=2, alpha=0.5)
